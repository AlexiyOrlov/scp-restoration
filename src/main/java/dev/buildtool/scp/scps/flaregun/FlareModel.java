package dev.buildtool.scp.scps.flaregun;// Made with Blockbench 3.7.5
...
public class FlareModel extends EntityModel<Flare> {
    ...
    @Override
    public void setupAnim(Flare entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
