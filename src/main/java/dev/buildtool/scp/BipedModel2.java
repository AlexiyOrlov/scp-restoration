...
/**
 * Use for humanoid entities
 */
public class BipedModel2<E extends LivingEntity> extends BipedModel<E> {
    ...
    public void renderToBuffer(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        copyRotation(LeftLeg, super.leftLeg);
        copyRotation(RightLeg, super.rightLeg);
    ...
    protected Iterable<ModelRenderer> bodyParts() {
        return ImmutableSet.of(Body, RightArm, RightLeg, LeftArm, LeftLeg);
    }
    ...
    protected void copyRotation(ModelRenderer to, ModelRenderer from) {
        to.zRot = from.zRot;
        to.yRot = from.yRot;
        to.xRot = from.xRot;
    }
