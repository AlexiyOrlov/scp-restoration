...
import dev.buildtool.scp.scps.blockscps.*;
import dev.buildtool.scp.scps.clockworks.Panel;
import dev.buildtool.scp.scps.flaregun.Crate;
import dev.buildtool.scp.scps.infiniteikea.EntranceBlock;
import dev.buildtool.scp.scps.infiniteikea.ExitBlock;
import dev.buildtool.scp.scps.infiniteikea.SupportBlock;
import dev.buildtool.scp.scps.mailbox.Mailbox;
import dev.buildtool.scp.scps.mailbox.ParcelBlock;
import dev.buildtool.scp.scps.monsterpot.MonsterPot;
import dev.buildtool.scp.scps.oldai.OldAIBlock;
import dev.buildtool.scp.scps.pipenightmare.Explodable;
import dev.buildtool.scp.scps.pipenightmare.Pipe;
import dev.buildtool.scp.scps.repeatingbomb.Bomb;
...
public class SCPBlocks {
    ...
    public static dev.buildtool.scp.scps.shelflife.ShelfBlock shelfLifeBlock;
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> register)
    {
        ...
        shelfLifeBlock = registerBlock(new dev.buildtool.scp.scps.shelflife.ShelfBlock(properties().noOcclusion().sound(SoundType.WOOD).harvestTool(ToolType.AXE)), "shelf_life_block", forgeRegistry);
