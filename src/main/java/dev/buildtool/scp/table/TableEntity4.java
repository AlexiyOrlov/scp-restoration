...
public class TableEntity4 extends BlockEntity2 implements LootContainer {
    ItemHandler itemHandler=new ItemHandler(4,this);
    LazyOptional<ItemHandler> lazyOptional;
    ProxyInventory proxyInventory=new ProxyInventory(itemHandler);
    public TableEntity4(TileEntityType<?> tileEntityType) {
